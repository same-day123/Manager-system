<template>
  <div class="app-container tree-sidebar-manage-wrap">
    <tree-panel title="学院/实验室" :tree-data="deptOptions" search-placeholder="请输入学院或实验室名称" storage-key="dept-sidebar-width" :defaultExpandAll="true" @node-click="handleNodeClick" @refresh="getDeptTree" ref="deptTreeRef" />
    <div class="tree-sidebar-content">
      <div class="content-inner">
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="学院/实验室" align="center" key="deptName" prop="dept.deptName" v-if="columns.deptName.visible" :show-overflow-tooltip="true" />
    ...
    <el-dialog :title="title" v-model="open" width="600px" append-to-body>
      <el-form :model="form" :rules="rules" ref="userRef" label-width="80px">
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="学院/实验室" prop="deptId">
              <el-tree-select v-model="form.deptId" :data="enabledDeptOptions" :props="{ value: 'id', label: 'label', children: 'children' }" value-key="id" placeholder="请选择学院或实验室" clearable check-strictly />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
...
const columns = ref({
  ...
  deptName: { label: '学院/实验室', visible: true },
